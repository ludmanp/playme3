...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->loadViewsFrom(resource_path('views'), 'blocks');
        $this->loadViewsFrom(resource_path('views'), 'core');
        $this->loadViewsFrom(resource_path('views'), 'dashboard');
        $this->loadViewsFrom(resource_path('views'), 'files');
        $this->loadViewsFrom(resource_path('views'), 'menus');
        $this->loadViewsFrom(resource_path('views'), 'pages');
        $this->loadViewsFrom(resource_path('views'), 'roles');
        $this->loadViewsFrom(resource_path('views'), 'search');
        $this->loadViewsFrom(resource_path('views'), 'settings');
        $this->loadViewsFrom(resource_path('views'), 'tags');
        $this->loadViewsFrom(resource_path('views'), 'taxonomies');
        $this->loadViewsFrom(resource_path('views'), 'translations');
        $this->loadViewsFrom(resource_path('views'), 'users');
